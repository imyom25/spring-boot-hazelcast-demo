package com.yom.hazelcast.hazelcastdemo;

import com.yom.hazelcast.hazelcastdemo.service.MusicService;
...
public class HazelcastDemoApplication implements CommandLineRunner{
	...
	private static Logger log = LoggerFactory.getLogger(HazelcastDemoApplication.class);
